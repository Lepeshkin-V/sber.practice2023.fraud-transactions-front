...
import { LineStatisticType, LineType } from "../../common/types";
...
import { template_line_statistic_data } from "../../common/templates";
...
const Chart = () => {
    ...
    console.log(template_line_statistic_data)
    statisticStore.statisticData.forEach(d => {
